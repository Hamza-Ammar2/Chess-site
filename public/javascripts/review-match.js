...
let match = JSON.parse(canvas.dataset.match);

t1.innerText = match.player2;
t2.innerText = match.player1;

game = new Board(false, true);


game.positions = JSON.parse(match.positions);
console.log(game.positions);
game.renderPos(game.positions.length - 1);
